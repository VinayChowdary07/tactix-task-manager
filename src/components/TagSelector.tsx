...
const TagSelector: React.FC<TagSelectorProps> = ({
  ...
  const safeSelectedTagIds = Array.isArray(selectedTagIds) ? selectedTagIds.filter(Boolean) : [];
  const safeTags = Array.isArray(tags) ? tags.filter(tag => tag && tag.id && tag.name) : [];
